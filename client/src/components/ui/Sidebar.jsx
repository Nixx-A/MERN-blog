...
export default function Sidebar ({ isOpen, setIsOpen }) {
  return (
    <>
      <aside className={`${isOpen ? 'absolute left-0 top-0' : 'absolute left-[-100%] top-0'} md:block md:relative md:ml-12 md:overflow-hidden md:left-0 md:mr-2 md:bg-[#efefef] flex flex-col  h-screen bg-white w-3/4 md:w-2/6 duration-150 overflow-y-scroll z-10`}>

...
export default function RightPostSidebar ({ author }) {
  ...
  return (
    <aside className="ml-2 overflow-hidden z-10 w-[30%] h-full hidden p-4 lg:block rounded bg-gray-100 shadow-sm dark:bg-[#171717]">
      <Link className='flex gap-x-2' to={`/profile/${author._id}`}>
        ...
        <p className="text-gray-300 mt-2 hover:text-indigo-600 dark:hover:text-indigo-400">{author.username}</p>
      </Link>

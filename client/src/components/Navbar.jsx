        ...
        <div className='w-full md:w-[97%] lg:w-[90%] m-auto flex items-center h-14'>
          ...
          {isAuthenticated
            ? <div className='ml-auto flex items-center gap-x-2'>
              ...
              <img className='w-8 h-8 rounded-full border border-black cursor-pointer hover:border-indigo-600 mr-4' onClick={() => setimgSidebarOpen(!imgSidebarOpen)} src='/nutritionist.png' />
